...
- **Xcode 26.5 (17F42), Apple Swift 6.3.2**, full Xcode installed with first-launch setup/license completed. Command Line Tools alone cannot build the app. The app targets macOS 14+, which is distinct from the host OS needed to run Xcode. Verification used Apple silicon on macOS 26.6.2. Older compiler and Intel compatibility are unverified.
