...
Concept and architecture exploration. The statements above describe the intended product; implementation choices and the first demonstration are still to be decided.
