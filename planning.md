...
| Distribution | Hosted backend by default. Reviewers may download the source and run the build script without an Apple Developer membership. Peter has no active membership; notarization is optional and must not block the demo. |
